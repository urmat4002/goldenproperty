...
export const Select: FC = () => {
  ...
  return (
    <div className={style.Select} onClick={() => setCity(true)}>
      <div
        className={city ? style.Select__city : style.Select__city__active}
      ...
      >
        ...
        <div
          className={
            city ? style.Select__options : style.Select__options__active
          }
        >
          <ul onClick={ChangeValue}>
            <input checked={checkboxDubai} type="checkbox" />
            <li>{optionsCity.dubai}</li>
          </ul>
          <ul onClick={ChangeValue2}>
            <input type="checkbox" checked={checkboxIstambul} />
            <li>{optionsCity.istanbul}</li>
          </ul>
          <ul>
            <input type="checkbox" checked={checkboxAntalya} />
            <li onClick={ChangeValue3}>{optionsCity.antalya}</li>
          </ul>
          <ul>
            <input checked={checkboxAll} type="checkbox" />
      ...
      <div className={type ? style.Select__type : style.Select__city__active}>
        ...
        <div
          className={
            type ? style.Select__options : style.Select__options__active
          }
        >
          <ul>
            <input type="checkbox" />
      ...
      <div
        className={popular ? style.Select__popular : style.Select__city__active}
      >
        ...
        <div
          className={
            popular ? style.Select__options : style.Select__options__active
          }
        >
          <ul>
            <input type="checkbox" />
      ...
      <button onClick={showResults} className={style.Select__btn}>
        Show results
      </button>
    </div>
  );
